...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'oauth_uid' => ['type' => 'string', 'length' => 32, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            ...
            'oauth_provider' => ['type' => 'index', 'columns' => ['oauth_provider'], 'length' => []],
            'status' => ['type' => 'index', 'columns' => ['status'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'username' => ['type' => 'unique', 'columns' => ['username'], 'length' => []],
            'oauth_uid' => ['type' => 'unique', 'columns' => ['oauth_uid'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'created' => '2015-05-30 07:16:37',
            'modified' => '2015-05-30 07:16:37'
        ],
    ];
}
