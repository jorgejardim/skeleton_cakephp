...
function getNavElement(current) {
    var currentText = $.trim(current.find(">a").html()),
        element = "";
    element += "<li class='"+$(current).attr('class')+"'><a href='" + current.find(">a").attr("href") + "'>" + currentText + "</a>";
...
$(document).ready(function() {
    ...
    $("#navigation .main-nav").on('click', 'li.search a', function(e) {
        $("#navigation .main-nav li").toggle( "slide", function() {
            $("#navigation .main-nav .search-form input").focus();
        });
    });

    $("#navigation .main-nav").on('click', '.search-form i', function(e) {
        $("#navigation .main-nav li").toggle( "slide");
        $("#navigation .main-nav .search-form input").val('');
    });
