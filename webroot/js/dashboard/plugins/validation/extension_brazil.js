...
jQuery.validator.addMethod("datetimeBR", function (value, element) {
    ...
    if (value.substr(10, 1) != ' ') return (this.optional(element) || false); // verificando se hÃƒÂ¡ espaÃƒÂ§o
    var arrOpcoes = value.split(' ');
    if (arrOpcoes.length != 2) return (this.optional(element) || false); // verificando a divisÃƒÂ£o de data e hora
    // verificando data
